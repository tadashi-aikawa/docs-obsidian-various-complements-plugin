...
## I don't want suggestions to appear automatically

Turn [[⚙️ Complement automatically]] OFF.

Suggestions will not be displayed unless you execute the [[🎮 Show suggestions]] command.
